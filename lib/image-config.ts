// 🖼️ SURUCHI'S KITCHEN - PREMIUM IMAGE CONFIGURATION
// ==================================================
// This file contains ALL image paths for the premium restaurant website.
// To replace any image, simply update the URL in this file.

// 📋 PREMIUM SETUP GUIDE:
// 1. Upload high-quality images (minimum 1920x1080 for hero, 600x400 for menu items)
// 2. Use professional food photography with proper lighting
// 3. Ensure consistent styling and color grading across all images
// 4. Save this file - all images will update automatically!

// 🏢 PREMIUM HOTEL BRANDING & LOGOS
export const BRANDING_IMAGES = {
  // Main hotel logo (recommended size: 200x200px, high resolution)
  logo: "/images/hotel-logo.png",

  // Premium loading screen logo (recommended size: 100x100px)
  loadingLogo: "/placeholder.svg?height=80&width=80&text=🍳",
...
// ===============================
// This is the main section for high-quality food photography!
// Use professional food photos with proper styling and garnishing.
